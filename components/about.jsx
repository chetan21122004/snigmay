    ...
    >
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div
            ref={imageRef}
            className="relative h-[250px] md:h-[400px] rounded-lg overflow-hidden"
          >
            <Image
        ...
        <div className="mb-16">
          ...
          {isMobile ? (
            <Carousel className="w-full">
              <CarouselContent>
                <CarouselItem>
                  <Card className={`animate-on-scroll ${inView ? "visible" : ""} h-full`}>
                    <CardContent className="p-6">
                      <div className="flex items-center justify-center mb-4">
                        <Users2 className="h-7 w-7 text-primary" />
                      </div>
                      <h3 className="text-xl font-bold mb-2 text-center">01. Social Inequality</h3>
                ...
                <CarouselItem>
                  <Card className={`animate-on-scroll ${inView ? "visible" : ""} delay-100 h-full`}>
                    <CardContent className="p-6">
                      <div className="flex items-center justify-center mb-4">
                        <Briefcase className="h-7 w-7 text-primary" />
                      </div>
                      <h3 className="text-xl font-bold mb-2 text-center">02. Limited Resources</h3>
                      <p className="text-muted-foreground text-center">
                ...
                <CarouselItem>
                  <Card className={`animate-on-scroll ${inView ? "visible" : ""} delay-200 h-full`}>
                    <CardContent className="p-6">
                      <div className="flex items-center justify-center mb-4">
                        <Target className="h-7 w-7 text-primary" />
                      </div>
                      <h3 className="text-xl font-bold mb-2 text-center">03. Missed Potential</h3>
                      <p className="text-muted-foreground text-center">
                ...
                <CarouselItem>
                  <Card className={`animate-on-scroll ${inView ? "visible" : ""} delay-300 h-full`}>
                    <CardContent className="p-6">
                      <div className="flex items-center justify-center mb-4">
                        <Eye className="h-7 w-7 text-primary" />
                      </div>
                      <h3 className="text-xl font-bold mb-2 text-center">04. Lack of Visibility</h3>
                      <p className="text-muted-foreground text-center">
        ...
        <div>
          ...
          {isMobile ? (
            <Carousel className="w-full">
              <CarouselContent>
                <CarouselItem>
                  <Card className={`animate-on-scroll ${inView ? "visible" : ""} h-full`} ref={ref}>
